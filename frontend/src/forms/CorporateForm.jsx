...
const CorporateForm = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    await submitClientData({ clientType: 'Corporate', ...form });
    alert('Submitted successfully!');
    setForm({
      businessName: '', businessPAN: '', tan: '', gst: '',
      address: '', contact: '', accountantName: '', accountantEmail: '',
      gstState: '', gstNumber: ''
    });
  };
  ...
  return (
    <div>
      <h2>KVSB & Associates - Corporate Form</h2>
